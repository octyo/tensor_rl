...
def plot_trajectory(trajectory, env=None, xkeys=None, ukeys=None):
    """
    Used to visualize trajectories returned from the :func:`~rl_course.ex01.agent.train`-function. An example:
    ...
    .. plot::
        ...
        import matplotlib.pyplot as plt
        import numpy as np
        from rl_course import Agent, plot_trajectory, train
        from rl_course.ex04.model_pendulum import GymSinCosPendulumEnvironment
