...
import numpy as np
import os, glob, csv
from rl_course.utils.lazylog import LazyLog
...
def average_trajectories(trajectories):
    if len(trajectories) == 0:
        return None
    from rl_course.ex01.agent import Trajectory, fields
    t = trajectories[0]
    # t._asdict()
...
def experiment_load(experiment_name, exclude_empty=True):
    ...
    for recent in files:
        ...
        from rl_course import cache_read, cache_write, cache_exists
