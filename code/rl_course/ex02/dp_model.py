...
class DPModel: 
    ...
    .. Note::
        ...
        to planning methods such as the DP-algorithm (see the function :func:`~rl_course.ex02.dp.DP_stochastic`)
        all at once.
    ...
    You should take a look at :func:`~rl_course.ex02.inventory.InventoryDPModel` for a concrete example.
    ...
    def w_rnd(self, x, u, k): 
        ...
        :func:`rl_course.ex02.dp_model.DPModel.Pw`, i.e. it returns a sample:
