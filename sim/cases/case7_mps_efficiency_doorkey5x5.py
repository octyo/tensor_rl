"""
Case 7 (DoorKey-5x5): MPS Efficiency Deep-Dive on a harder map
================================================================
Replicates Case 7 on MiniGrid-DoorKey-5x5-v0 — a harder task requiring
sequential sub-goals (key → door → goal). Tests whether MPS's low-rank
efficiency advantage observed on Empty-5x5 holds on a more complex task.

Sub-experiment A: MPS rank sweep r1–r8  (5 seeds, 300 eps)
...
Seeds: 5  |  Episodes: 300  |  Algo: double_dqn
"""
...
OUT_FILE   = os.path.join(os.path.dirname(__file__),
                          'case7_mps_efficiency_doorkey5x5_output.txt')
...
def main():
    ...
    title        = (f"Case 7 (DoorKey-5x5): MPS Efficiency  "
