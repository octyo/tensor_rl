"""
Case 0a (DoorKey-5x5): Baseline Double DQN on a harder map
============================================================
Replicates Case 0a (hidden-layer sweep with Double DQN) on MiniGrid-DoorKey-5x5-v0.
DoorKey requires the agent to: find the key, pick it up, open the locked door,
then reach the goal — a genuinely harder sequential task than Empty-5x5.

Sweep: hidden_sizes in [(64,), (128,), (64,64), (128,128)]
Seeds: 3  |  Episodes: 300  |  Algo: double_dqn
"""
...
OUT_FILE = os.path.join(os.path.dirname(__file__), 'case0a_doorkey5x5_output.txt')
...
def main():
    ...
    title        = (f"Case 0a (DoorKey-5x5): Baseline Double DQN  "
